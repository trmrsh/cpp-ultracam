...
foreach $file ('addaframe.csh', 'averun.csh', 'breakup.csh', 'busca2ucm.py', 'copymask.pl', 'dummy.pl', 
	       'extract_times.csh', 'fmatch.py', 'l3gain.pl', 'loggen.csh', 'makebias.csh', 'missbias.py', 
	       'mulaframe.csh', 'newreduce.pl', 'setup.pl', 'shiftaper.pl', 'splitr.pl', 'sumframes.csh', 
	       'transform.pl', 'ucat.csh', 'uls.csh', 'ult2asc.pl', 'unique.py', 'updateaper.pl'){
...
<html>
<head>
<title>ULTRACAM Pipeline Software Version 8.1.43</title>
<link rel=stylesheet href="ultracam.css" type="text/css">
</head>
<body>

<h1>The ULTRACAM Pipeline Software Version 8.1.43 Home Page</h1>
<p>
...
with version 8.1.43 of the pipeline.
